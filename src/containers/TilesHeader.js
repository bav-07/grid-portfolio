        ...
        <div 
            ...
            {Array.from(Array(columns * rows)).map((tile, index) => {
                return <div className={`tile group
                    ...
                    {pageState === "" && loadState == false && index === columns * 4 + 1 ? <p className='absolute delay-0ms text-white font-["Orbitron"] text-xl md:text-3xl opacity-70 uppercase z-50 top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] group-hover:scale-150 transition-transform duration-150'><IoSquareSharp/></p> : ""}
                    {pageState === "" && loadState == false && index === columns * 6 + 1 ? <p className='absolute delay-0ms text-white font-["Orbitron"] text-xl md:text-3xl opacity-70 uppercase z-50 top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] group-hover:scale-150 transition-transform duration-150'><IoSquareSharp/></p> : ""}
                    {pageState === "" && loadState == false && index === columns * 8 + 1 ? <p className='absolute delay-0ms text-white font-["Orbitron"] text-xl md:text-3xl opacity-70 uppercase z-50 top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] group-hover:scale-150 transition-transform duration-150'><IoSquareSharp/></p> : ""}
